...
import funkcionalna1 from "@/assets/funkcionalna-1.webp";
import funkcionalna2 from "@/assets/funkcionalna-2.webp";
import ponudaSpa from "@/assets/ponuda-spa.webp";
import nakonTreningaBar from "@/assets/nakon-treninga-bar.webp";
import trenerJosip from "@/assets/trener-josip.webp";
import trenerAnita from "@/assets/trener-anita.webp";
          ...
          <div className="container mx-auto max-w-6xl relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
              ...
              <div className="text-center flex flex-col">
                <h2 className="text-2xl md:text-4xl font-extrabold font-display mb-4 min-h-[4.5rem] flex items-center justify-center gap-2 whitespace-nowrap">
                  <Dumbbell className="w-7 h-7 md:w-8 md:h-8 text-secondary flex-shrink-0" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
            ...
            <div className="relative overflow-hidden rounded-2xl gradient-border shadow-warm group">
              ...
              <div className="relative z-10 p-6 md:p-8 text-center min-h-[260px] md:min-h-[300px] flex flex-col items-center justify-center">
                ...
                <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                  Članovi imaju pogodnosti korištenja finske saune, turske kupelji i hidromasažnog bazena u Spa centru Čardaci.
                </p>
              </div>
            </div>
          </div>
